...
function lazyInitializer(storage, modulePath) {
  storage ??= require(modulePath);
  return storage;
}

let internalUtil;
function lazyInternalUtil() {
  return lazyInitializer(internalUtil, 'internal/util');
}

let utilColors;
function lazyUtilColors() {
  return lazyInitializer(utilColors, 'internal/util/colors');
}

let buffer;
function lazyBuffer() {
  return lazyInitializer(buffer, 'buffer').Buffer;
}
